...
function setData() {
    ...
    for (var i = 0; i <= 49; i++) {
        ...
        admin[i] = new class_1.AdminUser(mockData.get_resach(), mockData.get_resach(), mockData.getMoble(), mockData.get_sta_demerits(), mockData.get_sta_demerits(), id, mockData.getName(), mockData.get_age(), mockData.get_sex(), '', identity, mockData.get_data(), mockData.randomWord(false, 4, 8));
